...
posties.util = (function() {
  ...
  // Get the YouTube video ID from a URL. Supports multiple YouTube URL types,
  // such as embed and watch.
  // returns false if the url parameter isn't a valid YouTube url
